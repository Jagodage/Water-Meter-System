...
export default function Tap({ value, onChange }) {
  ...
  return (
    <Box sx={{ minWidth: 300 }}>
      <h2 className="dashboard-text">Tap</h2>
      <FormControl fullWidth size="small">
        <TextField id="outlined-basic" label="Tap ID" variant="outlined" onChange={handleChange}/>
