...
export default function Walve({ value, onChange }) {
  ...
  return (
    <Box sx={{ minWidth: 300 }}>
      <h2 className="dashboard-text">Walve</h2>
      <FormControl fullWidth size="small">
        <TextField id="outlined-basic" label="Meeter ID" variant="outlined" onChange={handleChange}/>
